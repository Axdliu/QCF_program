...
plot(loan_data$age, loan_data$annual_inc, ylab = "Annual Income", xlab = "Age")
...
log_model_multi = glm(loan status ~ age + ir_cat + grade + loan_amnt + annual_inc, family = 'binomial', data = training_set)
